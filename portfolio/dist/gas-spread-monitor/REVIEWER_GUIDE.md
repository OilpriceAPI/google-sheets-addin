# Gas Spread Monitor by OilPriceAPI — reviewer guide
...
- The reviewer fixture must be synthetic, non-customer, active for the review window, and entitled to: `NATURAL_GAS_USD`, `DUTCH_TTF_EUR`, `JKM_LNG_USD`, `EUR_USD`.

## End-to-end review flow

1. Install the unpublished Marketplace draft in a blank spreadsheet.
2. In **Extensions → Add-ons → Manage add-ons**, select Gas Spread Monitor by OilPriceAPI and choose **Use in this document**.
3. Refresh the spreadsheet once.
4. Open **Extensions → Gas Spread Monitor → Configure OilPriceAPI key**.
...
8. Confirm these product-specific tabs exist: `Gas Spread Monitor`, `Market Data`, `Conversion Audit`.
...
- Apps Script ID: `1Od5dLY-A8l-sULQidIuso3rJRjJvWIaI54JZpPQlCVyAk32phv2D1YSU`
