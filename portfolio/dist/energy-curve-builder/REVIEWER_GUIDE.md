# Energy Curve Builder by OilPriceAPI — reviewer guide
...
- The reviewer fixture must be synthetic, non-customer, active for the review window, and entitled to: `ice-wti` and `ice-brent` futures curves.

## End-to-end review flow

1. Install the unpublished Marketplace draft in a blank spreadsheet.
2. In **Extensions → Add-ons → Manage add-ons**, select Energy Curve Builder by OilPriceAPI and choose **Use in this document**.
3. Refresh the spreadsheet once.
4. Open **Extensions → Energy Curve Builder → Configure OilPriceAPI key**.
...
8. Confirm these product-specific tabs exist: `Curve Dashboard`, `WTI Curve`, `Brent Curve`, `Calendar Spreads`.
