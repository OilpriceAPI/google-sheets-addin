# Bunker Voyage Planner by OilPriceAPI — pre-submission checklist

Target Cloud project ID: `oilpriceapi-bunker-voyage`
...
- [ ] Create the separate standard Google Cloud project `oilpriceapi-bunker-voyage`
