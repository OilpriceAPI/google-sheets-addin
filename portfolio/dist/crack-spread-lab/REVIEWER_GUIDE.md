# Crack Spread Lab by OilPriceAPI — reviewer guide
...
- The reviewer fixture must be synthetic, non-customer, active for the review window, and entitled to: `WTI_USD`, `GASOLINE_USD`, `HEATING_OIL_USD`.

## End-to-end review flow

1. Install the unpublished Marketplace draft in a blank spreadsheet.
2. In **Extensions → Add-ons → Manage add-ons**, select Crack Spread Lab by OilPriceAPI and choose **Use in this document**.
3. Refresh the spreadsheet once.
4. Open **Extensions → Crack Spread Lab → Configure OilPriceAPI key**.
...
8. Confirm these product-specific tabs exist: `Crack Model`, `Market Data`, `History`, `Sensitivity`.
...
- Apps Script ID: `1c2O84bJoprkUtyo8eHb-yYmz1Mtttpo-8miUrKf3o3rzrVXUBfFU8M5C`
- Immutable Apps Script version: `New immutable version required`
- Previous immutable version (superseded): `3`
