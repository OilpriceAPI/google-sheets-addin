# Fuel Surcharge Studio by OilPriceAPI — pre-submission checklist

Target Cloud project ID: `oilpriceapi-fuel-surcharge`
...
- [ ] Create the separate standard Google Cloud project `oilpriceapi-fuel-surcharge`
