# Energy Curve Builder by OilPriceAPI — pre-submission checklist

Target Cloud project ID: `oilpriceapi-energy-curve`
...
- [ ] Create the separate standard Google Cloud project `oilpriceapi-energy-curve`
