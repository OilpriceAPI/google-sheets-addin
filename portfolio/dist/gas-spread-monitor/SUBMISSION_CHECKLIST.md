# Gas Spread Monitor by OilPriceAPI — pre-submission checklist

Target Cloud project ID: `oilpriceapi-gas-spread`
...
- [ ] Create the separate standard Google Cloud project `oilpriceapi-gas-spread`
